...
// Configuration
const EXCEL_FILE = path.join('d:', 'ViralWindow_Phan_Mem_Nhom_Kinh', 'Tài liệu', 'Tồn kho KOSO yangly.xlsx');
const TARGET_WAREHOUSE_ID = 2; // Kho Nhôm YANGLY

async function importData() {
    let connection;
    try {
        console.log('🚀 DỰ ÁN: NHẬP DỮ LIỆU TỒN KHO KOSO - YANGLY');
        ...
        // Skip header rows (Data starts after row 0)
